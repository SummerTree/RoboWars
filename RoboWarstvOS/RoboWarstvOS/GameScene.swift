   ...
   var highScoreLabel:SKLabelNode = SKLabelNode()
                        ...
                        if (theDictionary is [String : AnyObject]) {
                            ...
                            if let currentDictionary:[String : AnyObject] = theDictionary as? [String : AnyObject] {
                                ...
                                for (theKeyWithPossibleSpaces, theValue) in currentDictionary {
                                    ...
                                    let theKey:String  = theKeyWithPossibleSpaces.replacingOccurrences(of: " ", with: "", options:String.CompareOptions.caseInsensitive , range: nil)
                                    ...
                                    }     else if (theKey.lowercased() == "MP3Loop".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "AutoAdvanceLevelTime".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "SoundLevelBegin".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "StealHeartsSound".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "SoundLevelFail".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "SoundLevelSucceed".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "SoundPlayer1Win".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "SoundPlayer2Win".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "SoundUnpaused".lowercased()) {
                                    ...
                                    } else if (theKey.lowercased() == "DisableContinue".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "UnlimitedBullets".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "MaxDistanceBetweenPlayersX".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "PlayerVersusPlayer".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "StealHearts".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "KeepExistingBulletCount".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "BoundaryFlip".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "LevelResetsHearts".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "RefreshLevelOnDeath".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "ResetScore".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "CombineScoresToPassLevel".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "PassLevelWithScoreOver".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "PassLevelWithEnemiesKilled".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "GoalMultipliedByLevelsPassed".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "HalfGoalsToPassForOnePlayer".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "BulletsToStart".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "MaxBulletsToStart".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "PlayerOnPlayerBounceThreshold".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "PlayerOnPlayerImpact".lowercased()) {
                                    ...
                                    else if (theKey.lowercased() == "Player1Ammo".lowercased()) {
    ...
    func createEnemy(_ enemyDictionary:[String : AnyObject ], theTotal:Int, waitTime:TimeInterval ){
       ...
       //// for the enemy being spawned
        ...
        var explodeAsBullet:Bool = false
